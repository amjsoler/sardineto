...
class MarcarSuscripcionComoPagadaTest extends TestCase
{
    ...
    {
        $response = $this->getJson(route("marcar-suscripcion-pagada",
            [
    ...
    public function test_marcar_suscripcion_como_pagada_sin_verificar_cuenta()
    {
    ...
    public function test_marcar_suscripcion_como_pagada_sin_autorizacion()
    {
    ...
    public function test_marcar_suscripcion_como_pagada_not_found_route_params()
    {
        $this->actingAs($this->propietario);
        $response = $this->getJson(route("marcar-suscripcion-pagada",
            [
    ...
    public function test_marcar_suscripcion_como_pagada_ok()
    {
        $this->actingAs($this->propietario);
