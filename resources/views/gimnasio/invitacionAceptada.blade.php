...
@section("title")
    {{ __("vistas.gimnasio.invitacionAceptada.title") }}
@endsection

@section("content")
    <section class="bg-gray-50 dark:bg-gray-900 min-h-dvh flex items-center">
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    @if($response["code"] == 0)
                        ...
                        <p class="block mb-2 font-medium text-center text-gray-900 dark:text-white">
                            {{ __("vistas.gimnasio.invitacionAceptada.ok1") }}
                        </p>
                        <p class="block mb-2 text-sm text-center text-gray-900 dark:text-white">
                            {{ __("vistas.gimnasio.invitacionAceptada.ok2") }}
                        </p>
                    @else
                        ...
                        <p class="block mb-2 font-medium text-center text-gray-900 dark:text-white">
                            {{ __("vistas.gimnasio.invitacionAceptada.ko1") }}
                        </p>
                        <p class="block mb-2 text-sm text-center text-gray-900 dark:text-white">
                            {{ __("vistas.gimnasio.invitacionAceptada.ko2") }}
                        </p>
                    @endif
                </div>
            </div>
